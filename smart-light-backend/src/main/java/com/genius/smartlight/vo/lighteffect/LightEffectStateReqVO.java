...
@Data
@Schema(description = "Light effect state request")
public class LightEffectStateReqVO {
    ...
    @Schema(description = "Target scope. all means all lamp/camlamp devices; other values match device displayName.", example = "all")
